...
//        if (checkExistenceByEmail(signupRequest.getEmail())) {
//            throw new ServiceException(ErrorCode.ACCOUNT_EXISTED);
//        }
//        // register
//        Users users = new Users();
//        users.setUsersId("BSB" + sequenceValueItemService.getSequence(Users.class));
//        users.setEmail(signupRequest.getEmail());
//        users.setPassword(encoder.encode(signupRequest.getPassword()));
//        users.setRoles(EnumConst.UserRolesEnum.ROLE_USER.toString());
//        users.setFullName(signupRequest.getFullName());
//        users.setPhone(signupRequest.getPhone());
//        users.setStatus(EnumConst.UserStatusEnum.DISABLE.toString());
...
//            usersPreference.setType(EnumConst.UserPreferenceTypeEnum.ACTIVE_ACCOUNT.toString());
...
//            String url = "http://localhost:5000/auth/verify-email/" + users.getUsersId() + "?code=" + usersPreference.getCode();
