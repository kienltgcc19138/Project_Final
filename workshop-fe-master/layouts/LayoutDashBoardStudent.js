...
//   getItem("Workshops", "/admin/workshops", <VideoCameraAddOutlined />),
//   getItem("Major", "/admin/major", <WalletOutlined />),
//   getItem("Course", "/admin/course",   <ContactsOutlined />),
  getItem("Recommend", "/recommend",  <MailOutlined />),
//   getItem("Chat", "/admin/chat",  <MessageOutlined />
//   ),
];

const LayoutDashBoardStudent = ({ children }) => {
...
export default LayoutDashBoardStudent;
